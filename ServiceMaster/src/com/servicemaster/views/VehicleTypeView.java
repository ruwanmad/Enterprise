 ...
 * @author RuwanM
 */
public class VehicleTypeView extends javax.swing.JInternalFrame {

    private final List list;
    private final VehicleTypeFrame vehicleTypeFrame;

    /**
     * Creates new form CategoryView
     *
     * @param list
     * @param vehicleTypeFrame
     */
    public VehicleTypeView(List<VehicleType> list, VehicleTypeFrame vehicleTypeFrame) {
        initComponents();
        this.list = list;
        this.vehicleTypeFrame = vehicleTypeFrame;
    }
    ...
    private void initComponents() {
        ...
        vehicleTypeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Veh. Type Code", "Veh. Type Name", "Remark", "Is Active"
            }
        ) {
        ...
        scrollPane.setViewportView(vehicleTypeTable);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        if (!list.isEmpty()) {
            DefaultTableModel tableModel = (DefaultTableModel) vehicleTypeTable.getModel();
            tableModel.setRowCount(0);
            for (Object object : list) {
                if (object instanceof VehicleType) {
                    VehicleType vehicleType = (VehicleType) object;
                    tableModel.addRow(new Object[]{vehicleType.getVehicleTypeCode(), vehicleType.getVehicleTypeName(), vehicleType.getRemark(), (vehicleType.getIsActive() == 1)});
                }
            }
        }
    ...
    private void selectVehicleType() {
        int selectedRow = vehicleTypeTable.getSelectedRow();
        VehicleType vehicleType = (VehicleType) list.get(selectedRow);
        vehicleTypeFrame.setVehicleTypeCode(vehicleType.getVehicleTypeCode());
        vehicleTypeFrame.setVehicleTypeName(vehicleType.getVehicleTypeName());
        vehicleTypeFrame.setRemark(vehicleType.getRemark());
        vehicleTypeFrame.setIsActive((vehicleType.getIsActive() == 1));
        vehicleTypeFrame.setVehicleTypeCodeEditable(false);
        vehicleTypeFrame.setBtnSaveText("Update");
        this.dispose();
    }

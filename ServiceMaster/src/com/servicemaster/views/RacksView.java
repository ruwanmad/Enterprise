 ...
 * @author RuwanM
 */
public class RacksView extends javax.swing.JInternalFrame {

    private final List list;
    private final RacksFrame rackFrame;
     ...
     * @param rackFrame
     */
    public RacksView(List<Rack> list, RacksFrame rackFrame) {
        initComponents();
        this.list = list;
        this.rackFrame = rackFrame;
    }
    ...
    private void initComponents() {
        ...
        subRackTable = new javax.swing.JTable();
        ...
        subRackTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Rack Code", "Rack Name", "Stor. Code", "Remark", "Is Active"
            }
        ) {
        ...
        subRackTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                subRackTableMouseClicked(evt);
            }
        });
        scrollPane.setViewportView(subRackTable);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        if (!list.isEmpty()) {
            DefaultTableModel tableModel = (DefaultTableModel) subRackTable.getModel();
    ...
    private void subRackTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_subRackTableMouseClicked
        int clickCount = evt.getClickCount();
        if (clickCount == 2) {
            this.selectRack();
        }
    }//GEN-LAST:event_subRackTableMouseClicked
    ...
    private void selectRack() {
        ...
        rackFrame.setBtnSaveText("Update");
        this.dispose();
    }
    ...
    private javax.swing.JTable subRackTable;

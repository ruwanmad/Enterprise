...
public class GrnLine implements java.io.Serializable {
    ...
    public GrnLine(GrnLineId id, Grn grn, Item item) {
        this.id = id;
        this.grn = grn;
        this.item = item;
    }

    public GrnLine(GrnLineId id, Grn grn, Item item, Float unitPrice, Float receivedQuantity, Float totalPrice, Float rejectedQuantity, String rejectedReason, Date createdDate, Date createdTime, Integer createdUser, Date modifiedDate, Date modifiedTime, Integer modifiedUser, String remark) {
        this.id = id;
        this.grn = grn;
        this.item = item;
    ...
    public GrnLineId getId() {
        return this.id;
    }

    public void setId(GrnLineId id) {
        this.id = id;
    }

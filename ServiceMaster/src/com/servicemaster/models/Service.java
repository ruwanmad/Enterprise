...
public class Service  implements java.io.Serializable {
    ...
    public Service(String serviceCode, ServiceBay serviceBay, Vehicle vehicle, Date createdDate, Date createdTime, Integer createdUser, Date modifiedDate, Date modifiedTime, Integer modifiedUser, String servicecol, Set serviceItems) {
       this.serviceCode = serviceCode;
       this.serviceBay = serviceBay;
       this.vehicle = vehicle;

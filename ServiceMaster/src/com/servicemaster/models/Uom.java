...
public class Uom implements java.io.Serializable {
    ...
    public Uom(String uomCode, String uomSymble, String uomName, Integer isActive, Date createdDate, Date createdTime, Integer createdUser, Date modifiedDate, Date modifiedTime, Integer modifiedUser, String remarks, Set itemsForBuyingUom, Set itemsForSellingUom, Set uomConversionsForUomUomCode, Set uomConversionsForUomUomCodeTo, Set bomItems) {
        this.uomCode = uomCode;

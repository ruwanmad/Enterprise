...
public class SubCategoryType  implements java.io.Serializable {
    ...
    public SubCategoryType(String subCategoryTypeCode, String subCategoryTypeName, Integer isActive, String remark, Date createDate, Date createTime, Integer createUser, Date modifiedDate, Date modifiedTime, Integer modifiedUser, Set subCategories) {
       this.subCategoryTypeCode = subCategoryTypeCode;

...
public class Item  implements java.io.Serializable {
    ...
    public Item(String itemCode, IssueMethod issueMethod, Item item, ItemBrand itemBrand, ItemType itemType, RackSlot rackSlot, SubCategory subCategory, Uom uomByBuyingUom, Uom uomBySellingUom, String itemName, String issueMethod_1, Float reorderQuantity, Float itemQuantity, Integer isPhysical, Integer isActive, Boolean fromBom, Date creadetDate, Date createdTime, Integer createdUser, Date modifiedDate, Date modifiedTime, Integer modifiedUser, String remark, Set items, Set boms, Set grnLines, Set sellingPrices, Set saleItems, Set stocks, Set bomItems) {
       this.itemCode = itemCode;
       this.issueMethod = issueMethod;
       this.item = item;
